...
<div
	class="space-y-2 rounded-lg border border-blue-100/60 bg-gradient-to-r from-blue-50/50 to-cyan-50/50 p-3 shadow-sm"
>
	<h4 class="flex items-center justify-between text-sm font-bold text-gray-700">
		<span>📱 Install as App</span>
		{#if isInstalled}
			<span class="badge badge-sm border-green-200 bg-green-100 text-green-700"> Installed </span>
		{/if}
	</h4>
	...
	<div class="space-y-2 pt-1">
		...
		{:else}
			<p class="mb-2 text-xs text-gray-600">Make TalkType feel like a native app on your device.</p>
			<button
