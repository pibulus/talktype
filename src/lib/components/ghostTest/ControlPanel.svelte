<script>
	...
	function toggleThemeSpecificRecording() {
		dispatch('themeSpecificRecordingChange', {
			...
			{#if customAnimations.length > 0}
				<div class="custom-animations">
					...
					{#if currentAnimation !== 'none' && customAnimations.find((a) => a.name === currentAnimation)}
						{@const activeAnimation = customAnimations.find((a) => a.name === currentAnimation)}
		...
		<div class="column">
			...
			<div class="control-section quick-actions">
				...
				<div class="animation-buttons">
					...
					<button on:click={() => dispatchAction('fullAnimationSequence')}
						>Animation Sequence</button
					>
		...
		<div class="column">
			...
			<div class="control-section">
				...
				<div class="animation-buttons">
					...
					<button on:click={() => dispatchAction('reactToTranscript', { length: 'short' })}
						>React (Short)</button
					>
					<button on:click={() => dispatchAction('reactToTranscript', { length: 'long' })}
						>React (Long)</button
					>
				</div>
				<div class="control-section">
