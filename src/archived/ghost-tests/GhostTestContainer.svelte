<script>
	...
	function handleApplyCustomAnimation(animation) {
		...
		// Apply new animation
		try {
			currentRemoveAnimation = animationGenerationService.applyAnimation(
				ghostSvgComponent,
				animation
			);
...
<div class="container">
	...
	<div class="test-container">
		...
		<ControlPanel
			...
			on:themeSpecificRecordingChange={(e) =>
				handleThemeSpecificRecordingChange(e.detail.useThemeSpecificRecording)}
