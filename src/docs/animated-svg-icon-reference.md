...
.icon-bg, .icon-base, .icon-animated {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.icon-bg { z-index: 1; } /* Bottom layer */
.icon-base { z-index: 2; } /* Middle layer */
.icon-animated { z-index: 3; } /* Top layer */
```
...
@keyframes active-animation {
  ...
  0%, 23%, 100% { transform: scaleY(1); }
  3% { transform: scaleY(0.8); }
  4% { transform: scaleY(1); }
  
  /* More complex sequences */
  40% { transform: scaleY(1); }
  42% { transform: scaleY(0.7); }
  43% { transform: scaleY(0.85); }
...
<div
  class="icon-container w-32 h-32 cursor-pointer md:w-56 md:h-56"
